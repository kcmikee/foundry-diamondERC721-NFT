...
function generateMerkleProof(targetAddress) {
    return __awaiter(this, void 0, void 0, function () {
        var addresses, testAddresses, leaves, tree, leaf, proof;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    leaves = addresses.map(function (addr) { return keccak256(addr); });
                    tree = new MerkleTree(leaves, keccak256, { sortPairs: true });
                    leaf = keccak256(targetAddress.toLowerCase());
